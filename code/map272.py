...
locations272_buckets = merge_overlapping_clusters(locations272_buckets, distance_threshold=300)

# Update cluster_uid to use merged version
locations272_buckets["cluster_uid"] = locations272_buckets["cluster_uid_merged"]
locations272_buckets = locations272_buckets.drop(columns=["cluster_uid_merged"])
