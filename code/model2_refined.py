...
""" IDS 68, 70, 328 """
""" IMPROVE MODEL ACCURACY - REMOVE CLIENT 67, 338 """
...
#plt.show()
fig.savefig("model_result/confusion_matrix_model2_refined.png", dpi=300, bbox_inches='tight')
plt.close(fig)
print("Confusion Matrix saved to 'model_result/confusion_matrix_model2_refined.png'")
print()
...
p68  = pred_labels[:n68]
p70 = pred_labels[n68:n68+n70]
p328 = pred_labels[n68+n70:n68+n70+n328]
...
compute_user_accuracy(locations68_buckets,  "Client 68")
compute_user_accuracy(locations70_buckets,  "Client 70")
compute_user_accuracy(locations328_buckets, "Client 328")