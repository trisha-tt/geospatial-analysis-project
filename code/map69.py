...
locations69_buckets = merge_overlapping_clusters(locations69_buckets, distance_threshold=300)

# Update cluster_uid to use merged version
locations69_buckets["cluster_uid"] = locations69_buckets["cluster_uid_merged"]
locations69_buckets = locations69_buckets.drop(columns=["cluster_uid_merged"])
