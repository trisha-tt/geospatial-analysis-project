...
locations273_buckets = merge_overlapping_clusters(locations273_buckets, distance_threshold=300)

# Update cluster_uid to use merged version
locations273_buckets["cluster_uid"] = locations273_buckets["cluster_uid_merged"]
locations273_buckets = locations273_buckets.drop(columns=["cluster_uid_merged"])
