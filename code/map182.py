...
locations182_buckets = merge_overlapping_clusters(locations182_buckets, distance_threshold=300)

# Update cluster_uid to use merged version
locations182_buckets["cluster_uid"] = locations182_buckets["cluster_uid_merged"]
locations182_buckets = locations182_buckets.drop(columns=["cluster_uid_merged"])
