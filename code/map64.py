...
locations64_buckets = merge_overlapping_clusters(locations64_buckets, distance_threshold=300)

# Update cluster_uid to use merged version
locations64_buckets["cluster_uid"] = locations64_buckets["cluster_uid_merged"]
locations64_buckets = locations64_buckets.drop(columns=["cluster_uid_merged"])
