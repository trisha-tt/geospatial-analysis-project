""" GENERIC MODEL FOR CLIENTS LIVING IN SPOKANE AREA """
""" IDS 67, 68, 70, 328, 338 """
...
print("Model 2: Individuals living in Spokane area")
...
print("Client 67 Clustering: ")  
locations67_buckets, _ = process_user('../locations/locations_67.csv')

print("Client 68 Clustering: ")  
locations68_buckets, _ = process_user('../locations/locations_68.csv')

print("Client 70 Clustering: ")  
locations70_buckets, _ = process_user('../locations/locations_70.csv')

print("Client 328 Clustering: ")
locations328_buckets, _ = process_user('../locations/locations_328.csv')

print("Client 338 Clustering: ")
locations338_buckets, _ = process_user('../locations/locations_338.csv')
...
locations_all = pd.concat([
    ...
    locations68_buckets,
    locations70_buckets,
    locations328_buckets,
    locations338_buckets
], ignore_index=True)
...
#plt.show()
fig.savefig("model_result/confusion_matrix_model2.png", dpi=300, bbox_inches='tight')
plt.close(fig)
print("Confusion Matrix saved to 'model_result/confusion_matrix_model2.png'")
print()
...
n67  = len(locations67_buckets)
n68  = len(locations68_buckets)
n70  = len(locations70_buckets)
n328 = len(locations328_buckets)
n338 = len(locations338_buckets)

p67  = pred_labels[:n67]
p68  = pred_labels[n67:n67+n68]
p70  = pred_labels[n67+n68:n67+n68+n70]
p328 = pred_labels[n67+n68+n70:n67+n68+n70+n328]
p338 = pred_labels[n67+n68+n70+n328:]

locations67_buckets['predicted']  = p67
locations68_buckets['predicted']  = p68
locations70_buckets['predicted']  = p70
locations328_buckets['predicted'] = p328
locations338_buckets['predicted'] = p338
...
compute_user_accuracy(locations67_buckets,  "User 67")
compute_user_accuracy(locations68_buckets,  "User 68")
compute_user_accuracy(locations70_buckets,  "User 70")
compute_user_accuracy(locations328_buckets, "User 328")
compute_user_accuracy(locations338_buckets, "User 338")