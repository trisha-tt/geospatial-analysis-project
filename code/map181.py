...
locations181_buckets = merge_overlapping_clusters(locations181_buckets, distance_threshold=300)

# Update cluster_uid to use merged version
locations181_buckets["cluster_uid"] = locations181_buckets["cluster_uid_merged"]
locations181_buckets = locations181_buckets.drop(columns=["cluster_uid_merged"])
